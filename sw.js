const CACHE='ripped-kitchen-v5';
const CORE=['./','./index.html','./styles.css','./data.js','./prep-bulk.js','./app.js','./manifest.webmanifest','./icons/icon.svg','./icons/icon-192.png','./icons/icon-512.png'];
